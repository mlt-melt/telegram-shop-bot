...
admins = []                         # [list]  list of admin's IDs (for example - [345345234, 557546745, 745985797])
...
languageForFeedback = ''            # [str]   set language for user's feedbacks which will send to feedback channel (only two params - "ru" or "en")
