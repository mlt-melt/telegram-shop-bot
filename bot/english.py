english = [
    ...
    'Enter the shipping cost:',
    'Enter the shipping cost as an integer or as a decimal number. Example: <code>143.55</code>',
    'Do you really want to add a shipping option:\n<b>Name</b>:',
    'In English:',
    'Cost',
    ...
    'Do you really want to remove the shipping method',
